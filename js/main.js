const gistURL = 'https://gist.githubusercontent.com/Igormandello/f290be423ba4b2df0d289685de2305d0/raw';

const classrooms = [
    '4', '5', '7', '8', '10', '11', '12', '13', '14', '15', 'Quadra'
]
...
function load(callback) {
	...
	request.onreadystatechange = function() {
      ...
      analyzer = new Analyzer(request.responseText, classrooms);
      callback();
    }
	}
}
  ...
  if (classes.classrooms === null) {
    ...
    if (available.length == 0) {
      ...
      div.children[1].innerText = 'This is so sad';
			...
			if (available.length == classrooms.length)
				div.children[1].innerText = 'Tudo livre';
			else
